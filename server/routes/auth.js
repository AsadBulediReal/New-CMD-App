...
router.post("/auth/register", async (req, res) => {
  try {
    ...
    // Check if this is the first user in the database or matches ADMIN_EMAIL
    const totalUsers = await User.countDocuments();
    const isConfiguredAdmin = process.env.ADMIN_EMAIL && normalizedEmail === process.env.ADMIN_EMAIL.trim().toLowerCase();
    ...
    // Notify Administrator of new registration
